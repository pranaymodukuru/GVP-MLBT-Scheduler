...
export function applySnap(snap) {
  ...
  if (snap.DUTY_TYPES)           state.DUTY_TYPES           = snap.DUTY_TYPES;
...
/** Download the current state as a JSON file to the browser. */
